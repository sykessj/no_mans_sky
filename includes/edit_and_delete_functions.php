...
//              "C:/xampp/htdocs/no_mans_sky/images/creatures/this_has_worked");
      ...
      $sql = $conn->prepare("SELECT * FROM `$database` WHERE `$name_column` = :id");
              ...
              debug_to_console( "Parent Planet is: $parent_planet" );
              }
              ...
              if($result != false){
                  debug_to_console( "Found parent planet" );
                  
                  
                  //get the current id for the item
                  $star_system = $result->star_system;
                  debug_to_console( "Star system is: $star_system" );
      ...
      $sql = $conn->prepare("SELECT * FROM `star_systems` WHERE `name` = :id");
              ...
              if($result != false){
                  debug_to_console( "Found star system" );
                  
                  //get the current id for the item
                  $galaxy = $result->galaxy;
                  debug_to_console( "Galaxy is: $galaxy" );
      ...
      $sql = $conn->prepare("SELECT * FROM `galaxy` WHERE `name` = :id");
              ...
              $sql = $conn->prepare("DELETE FROM `creatures` WHERE `name` = '$creature_name'");
              $sql->execute();
              } $creature_id++;
  }
              ...
              $sql = $conn->prepare("DELETE FROM `flora` WHERE `name` = '$flora_name'");
              $sql->execute();
              } $flora_id++;
  }
